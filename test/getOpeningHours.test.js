...
describe('Testes da função getOpeningHours', () => {
  it('sem argumentos deve retornar objeto com todos os dias e horarios', () => {
  ...
  it('Para os argumentos Thu e 09:00-AM deve deve lançar uma exceção com a mensagem The day must be valid. Example: Monday', () => {
